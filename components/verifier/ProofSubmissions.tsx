...
import { formatDate, formatDateTime, isExpired } from "@/helper/dateTime";
...
interface ProofSubmissionsProp {
    showModal: VerifierModal;
    setShowModal: (modal: VerifierModal) => void;
}

export default function ProofSubmissions({
    showModal,
    setShowModal,
}: ProofSubmissionsProp) {
    ...
    const verifyZkProof = useCredentialZKProofStore(
        (state) => state.verifyZkProof,
    );
    ...
    return (
        ...
        >
                                ...
                                >
                                    ...
                                    <div className="flex gap-2">
                                        <motion.button
                                            ...
                                            onClick={() => {
                                                setShowModal(
                                                    VerifierModal.ProofSubmissionDetail,
                                                );
            ...
            {showModal === VerifierModal.ProofSubmissionDetail && (
                <ProofSubmissionDetailModal
                    selectedSubmission={selectedSubmission}
                    onClose={() => {
                        setShowModal(VerifierModal.Null);
